...
export const UserItem = ({
    ...
    const defaultImageUrl = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png";

    return (
        <>
        <td>
          <img src= {`${user.imageUrl || defaultImageUrl}`}
        ...
        <td className="actions">
          <button className="btn edit-btn" title="Edit" onClick={() => onActionClick(user._id, UserActions.Edit)}>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-to-square"
              className="icon svg-inline--fa fa-pen-to-square" role="img" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 532 512">
          ...
          <button className="btn delete-btn" title="Delete" onClick={() => onActionClick(user._id, UserActions.Delete)}>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash"
              className="icon svg-inline--fa fa-trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 498 512">
              <path fill="currentColor"
          ...
          <button className="btn info-btn" title="Info" onClick={() => onActionClick(user._id, UserActions.Details)}>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info"
              className="icon svg-inline--fa fa-info" role="img" xmlns="http://www.w3.org/2000/svg"
